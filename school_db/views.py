...
def problem_four(request):
  ...
  students_amount = Student.objects.count()
  courses_amount = Course.objects.count()
  instructors_amount = Instructor.objects.count()

  print(f'Students Count: {students_amount}')
  print(f'Courses Count: {courses_amount}')
  print(f'Instructors Count: {instructors_amount}')
...
def problem_six(request):
    ...
    update_new_student = Student.objects.get(id=11)
    
    print(f'Id: {update_new_student.id}')
    print(f'Full Name: {update_new_student.first_name} {update_new_student.last_name}')
    print(f'GPA: {update_new_student.gpa}')
...
def problem_seven(request):
    ...
    delete_new_student = Student.objects.get(id=11)
